...
first_user =
  User.create!(name: '睡眠の神',
               ...
               password: 'nerukohasodatsu',
               password_confirmation: 'nerukohasodatsu',
...
eighth_user =
  User.create!(name: 'みる専',
               ...
               profile: '睡眠情報を収集することが目的のアカウント。発信する予定はないです。',
               avatar_url: 'https://s3.ap-northeast-1.amazonaws.com/s3.sleepingdebtplan.com/avatar/avatar_glasses.png',
               admin: false,
               activated: true,
               activated_at: Time.zone.now)
